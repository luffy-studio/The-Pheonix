      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          ...
          <motion.div variants={itemVariants} className="space-y-4">
            <h1 className="text-display  items-center leading-none">
              Beautiful
              <motion.div
                    initial={{ scaleX: 0 }}
                    animate={{ scaleX: 1 }}
                    transition={{ delay: 1.0, duration: 0.8 }}
                    className=" bottom-0 left-2 right-3 h-1 gradient-primary rounded-full"
                  />
            </h1>
          ...
          <motion.div variants={itemVariants} className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <motion.button
              ...
              className="interactive-button px-8 py-4 text-white font-semibold text-lg flex items-center space-x-2 min-w-[200px]"
            >
            ...
            <motion.button
              ...
              className="glass-card px-8 py-4 text-gray-700 font-semibold text-lg hover:text-gray-900 transition-colors min-w-[200px]"
            >
              View Demo
            </motion.button>
          </motion.div>
